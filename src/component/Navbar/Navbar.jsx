          ...
          <>
            <div className="customContainer">
              <div className="flex h-16 items-center justify-between">
                {!iSAdmin && <div className="flex items-center lg:hidden">
                  {/* Mobile menu button*/}
                ...
                <Link to={'/'}>
                  <div className="md:flex flex-shrink-0 items-center lg:ms-0 hidden">
                    <img
                    ...
                    <div>
                      <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-[transparent] px-3 py-2 text-sm font-semibold  shadow-sm ">
                        <div className="text-white flex justify-center items-center gap-2">
                          ...
                          } <span className="capitalize hidden sm:flex">{theme}</span>
                        </div>
              ...
              {!iSAdmin &&
                <DisclosurePanel className="lg:hidden flex  items-center justify-center flex-col order-3">
                  <div className="space-y-1 px-2 pb-3 pt-2 flex flex-col items-center gap-3">
                    <Link to={'/'}>
                      <div className="flex flex-shrink-0 items-center lg:ms-0">
                        <img
                          className="h-12 text-center "
                          src={logo}
                          alt="Your Company"
